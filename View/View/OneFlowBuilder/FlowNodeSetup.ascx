<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FlowNodeSetup.ascx.cs" Inherits="App.InfoGrid2.View.OneFlowBuilder.FlowNodeSetup" %>
...
<form action="" method="post">
    ...
    <mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="0" Padding="0">
        ...
        <mi:Panel runat="server" ID="panelMain1" Region="Center" Padding="4" Scroll="None">
            <mi:TabPanel runat="server" ID="panel1" Padding="200" Region="Center" Dock="Full" PaddingTop="10" UI="win10" ButtonVisible="false" TabLeft="10">
                <mi:Tab runat="server" ID="TabPanel1" Text="参与者" Scroll="None">
                    <mi:FormLayout runat="server" ID="FormLayout1" ItemWidth="300" PaddingTop="10" StoreID="storeMain1" ItemLabelWidth="150"
                        ItemLabelAlign="Right" Region="North" FlowDirection="TopDown" Dock="Top" AutoSize="true">
                        ...
                        <mi:NumberBox runat="server" ID="consignMinCountNb" FieldLabel="会签通过人数" DataField="P_CONSIGN_MIN_COUNT" />
                    ...
                    <mi:Panel runat="server" ID="panel2" PaddingLeft="150"  Region="Center" Dock="Full" Scroll="None">
                        ...
                        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" PagerVisible="false" ReadOnly="true">
                            <Columns>
                                <mi:RowNumberer />
                                <mi:RowCheckColumn />
                ...
                <mi:Tab runat="server" ID="Tab6" Text="抄送" Scroll="None">
                    ...
                    <mi:Panel runat="server" ID="panel3" PaddingLeft="140" Region="Center" Dock="Full" Scroll="None">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var ownerWindow = window.ownerWindow;

        if (ownerWindow) {
            ownerWindow.formClosing(function () {
                var me = this;

                var tb = Mini2.find('textBox4');
