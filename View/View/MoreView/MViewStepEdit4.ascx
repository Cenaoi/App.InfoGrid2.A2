<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MViewStepEdit4.ascx.cs" Inherits="App.InfoGrid2.View.MoreView.MViewStepEdit4" %>
...
<mi:Viewport runat="server" ID="viewport">
    ...
    <mi:Panel runat="server" ID="topPanel" Dock="Top" Region="North" Scroll="None">
        ...
        <mi:Table runat="server" ID="table2"  StoreID="storeTab" Height="80" PagerVisible="false"  Dock="Full">
            <Columns>
                <mi:RowNumberer />
...
--%>
                <mi:CheckColumn DataField="SUMMARY_VISIBLE" HeaderText="汇总栏" Width="100" />
            </Columns>
        </mi:Table>
    </mi:Panel>
