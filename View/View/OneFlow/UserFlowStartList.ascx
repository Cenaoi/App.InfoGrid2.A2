<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserFlowStartList.ascx.cs" Inherits="App.InfoGrid2.View.OneFlow.UserFlowStartList" %>
...
<form action="" method="post">
    ...
    <mi:Viewport runat="server" ID="viewport1">
        ...
        <mi:Panel runat="server" ID="mainLeft" Width="160" Region="West" PaddingLeft="4" PaddingRight="4">
            ...
            <a href="#" class="btn btn-info" style="width:100%; margin-bottom:6px;" role="button">我发起流程</a>
        ...
        <mi:Panel runat="server" ID="mainBox" Region="Center" Scroll="None">
            ...
            <mi:Toolbar runat="server" ID="toolbar1">
                <mi:ToolBarTitle Text="我发起的流程" ID="headText1" />
            </mi:Toolbar>
            ...
            <mi:Table runat="server" ID="table1" StoreID="store1" ReadOnly="true" Dock="Full" JsonMode="Full" ColumnLines="false" >
                <Columns>
                    ...
                    <mi:SelectColumn HeaderText="状态" DataField="FLOW_SID" StringItems="2=进行中;3=作废;4=已完成;" TriggerMode="None">
                    ...
                    <mi:BoundField HeaderText="用户编码" DataField="START_USER_CODE" Visible="false" />
                    <mi:BoundField HeaderText="发起人" DataField="START_USER_TEXT" />            
