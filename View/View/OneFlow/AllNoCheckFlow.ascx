<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AllNoCheckFlow.ascx.cs" Inherits="App.InfoGrid2.View.OneFlow.AllNoCheckFlow" %>
    ...
    <mi:Viewport runat="server" ID="viewport1">
        ...
        <mi:Panel runat="server" ID="mainBox" Region="Center" Scroll="None">
            ...
            <mi:SearchFormLayout runat="server" ID="searchFormLayout1" StoreID="store1">
                ...
                <mi:Button runat="server" ID="searchBtn1" Text="查询" Command="Reload" />
            </mi:SearchFormLayout>
            <mi:Toolbar runat="server" ID="toolbar1">
                <mi:ToolBarTitle Text="未审核流程" />
            </mi:Toolbar>
