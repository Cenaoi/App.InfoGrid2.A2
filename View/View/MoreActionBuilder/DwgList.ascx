<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DwgList.ascx.cs" Inherits="App.InfoGrid2.View.MoreActionBuilder.DwgList" %>

<%@ Register Assembly="EasyClick.Web.Mini2" Namespace="EasyClick.Web.Mini2" TagPrefix="mi" %>


<form action="" method="post">
    <mi:Store runat="server" ID="store1" Model="AC3_DWG" IdField="AC3_DWG_ID" DeleteRecycle="true"
         PageSize="20" SortText="AC3_DWG_ID desc" DefaultInsertPos="First">
        <FilterParams>
            <mi:Param Name="ROW_SID" DefaultValue="0" Logic="&gt;=" />
        </FilterParams>
        <DeleteQuery>
            <mi:ControlParam Name="AC3_DWG_ID" ControlID="table1" PropertyName="CheckedRows" />
        </DeleteQuery>
        <DeleteRecycleParams>
    ...
    <mi:Viewport runat="server" ID="viewport1">
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" ReadOnly="true" Region="Center" JsonMode="Full">
            <Columns>
                ...
                <mi:NumColumn HeaderText="#" DataField="AC3_DWG_ID" />
                <mi:BoundField HeaderText="联动编码" DataField="PK_DWG_CODE" />
                <mi:BoundField HeaderText="联动名称" DataField="DWG_TEXT" />
