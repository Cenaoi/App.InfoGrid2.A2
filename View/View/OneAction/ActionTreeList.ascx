<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActionTreeList.ascx.cs" Inherits="App.InfoGrid2.View.OneAction.ActionTreeList" %>
...
<mi:Viewport runat="server" ID="viewport1">
    ...
    <mi:Panel runat="server" ID="panel2" Region="West" Width="400">
        <mi:TreePanel runat="server" ID="TreePanel1" Dock="Full" Width="400" Region="West" >
            <Types>
