<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActionStepEdit2B.ascx.cs" Inherits="App.InfoGrid2.View.OneAction.ActionStepEdit2B" %>
...
<mi:Store runat="server" ID="store2" Model="IG2_ACTION_ITEM" IdField="IG2_ACTION_ITEM_ID" DeleteRecycle="true" SortField="ROW_USER_SEQ" >
    <FilterParams>
        <mi:QueryStringParam Name="IG2_ACTION_ID" QueryStringField="id" DbType="Int32"  />
    </FilterParams>
    <SelectQuery>
...
<!--左边过滤条件-->
<mi:Store runat="server" ID="storeLeft1" Model="IG2_ACTION_FILTER" IdField="IG2_ACTION_FILTER_ID" DeleteRecycle="true" SortField="ROW_USER_SEQ"  >
    <FilterParams>
        <mi:QueryStringParam Name="IG2_ACTION_ID" QueryStringField="id" DbType="Int32"  />
...
<!--右边过滤条件-->
<mi:Store runat="server" ID="storeRight1" Model="IG2_ACTION_FILTER" IdField="IG2_ACTION_FILTER_ID" DeleteRecycle="true" SortField="ROW_USER_SEQ"  >
    <FilterParams>
        <mi:QueryStringParam Name="IG2_ACTION_ID" QueryStringField="id" DbType="Int32"  />
...
<!--右边监听字段-->
<mi:Store runat="server" ID="storeRListen" Model="IG2_ACTION_LISTEN" IdField="IG2_ACTION_LISTEN_ID" DeleteRecycle="true" SortField="ROW_USER_SEQ"  >
    <FilterParams>
        <mi:QueryStringParam Name="IG2_ACTION_ID" QueryStringField="id" DbType="Int32"  />
        <mi:Param Name="ROW_SID" DefaultValue="0" Logic="&gt;=" />
    </FilterParams>
...
<mi:Viewport runat="server" ID="viewport">
    ...
    <mi:Panel runat="server" ID="buttonPanel1" Dock="Top" Region="North" Scroll="None" Padding="0" ItemMarginRight="6" Height="260">
        ...
        <mi:TabPanel runat="server" ID="TabPanle3" Dock="Top" Plain="true" Width="300"  Height="260">
            <mi:Tab runat="server" ID="tab3" Text="监听字段" Scroll="None">
                ...
                <mi:Table runat="server" ID="tableRListen" StoreID="storeRListen" PagerVisible="false" Dock="Full" Height="120" Width="300" Sortable="false">
                    <Columns>
                        <mi:RowNumberer />
                        <mi:RowCheckColumn />
        ...
        <mi:TabPanel runat="server" ID="TabPanel2" Dock="Top" Plain="true" Width="800"  Height="260">
            <mi:Tab runat="server" ID="tab2" Text="筛选-右" Scroll="None">
                ...
                <mi:Table runat="server" ID="tableRight" StoreID="storeRight1" PagerVisible="false" Dock="Full" Height="120" Width="300" Sortable="false">
                    <Columns>
                        <mi:RowNumberer />
                        <mi:RowCheckColumn />
        ...
        <mi:TabPanel runat="server" ID="tablePanel1" Dock="Top" Plain="true" Width="800" Height="260">
    ...
    <mi:TabPanel runat="server" ID="mainTabPanel1" Dock="Full" Padding="4" Plain="true" Region="Center" >
        <mi:Tab runat="server" ID="mainTab1" Text="赋值-左" Scroll="None">
            ...
            <mi:Table runat="server" ID="table2"  StoreID="store2"  Dock="Full" Region="Center" PagerVisible="false" Sortable="false">
                <Columns>
                    <mi:RowNumberer />
                    <mi:RowCheckColumn />
                    ...
                    <mi:BoundField DataField="R_VALUE_FUN" HeaderText="函数值-R" />
                    ...
                    <mi:SelectColumn DataField="L_ACT_CODE" HeaderText="动作" TriggerMode="None" ItemAlign="Center">
                        <mi:ListItem Value="" Text="" TextEx="-- N/A --" />
                        <mi:ListItem Value="A" Text="新建的时候赋值" />
                        <mi:ListItem Value="E" Text="只修改" />
                        <mi:ListItem Value="A-E" Text="修改和更新" />
                    </mi:SelectColumn>
...
<script type="text/javascript">
    ...
    function mappingFilterL_cols(owner) {
        ...
        $.get('/App/InfoGrid2/View/OneTable/OneTableStructure.aspx', {
            action: 'GET_FIELDS',
            table: curTable
