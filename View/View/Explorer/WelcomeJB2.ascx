<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WelcomeJB2.ascx.cs" Inherits="App.InfoGrid2.View.Explorer.WelcomeJB2" %>
        ...
        <div class="main-content-inner">
            ...
            <div class="row" style="margin-top:50px;">
                ...
                <div class="col-lg-12">
                    ...
                    <div id="left_chart" style="height: 500px; width: 100%; float: left"></div>
            ...
            <div class="row" style="margin-top:100px;">
                ...
                <div class="col-lg-12">
                    ...
                    <div id="091chart1" style="height: 300px; width: 100%; float: right"></div>
            ...
            <div class="row" style="margin-top:100px;">
                ...
                <div class="col-lg-12">
                    ...
                    <div id="091chart2" style="height: 300px; width: 100%; float: right"></div>
...
<script>
        ...
        $(function () {
            ...
            var myChart = echarts.init(document.getElementById('091chart1'));
            myChart.setOption(option);
            myChart.on('click', function (params) {
...
<script>
        ...
        $(function () {
            ...
            var myChart = echarts.init(document.getElementById('091chart2'));
            myChart.setOption(option);
            myChart.on('click', function (params) {
