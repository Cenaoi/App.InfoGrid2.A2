<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepNew1.ascx.cs" Inherits="App.InfoGrid2.View.OneSearch.StepNew1" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" RowLines="true" ColumnLines="true" StoreID="store1" CheckedMode="Single"  ReadOnly="true"
            ...
            <Columns>
                <mi:RowNumberer />
                <mi:RowCheckColumn />
                <mi:BoundField DataField="TABLE_NAME" HeaderText="数据表名" Width="120" />
