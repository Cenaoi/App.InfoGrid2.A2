<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepNew2.ascx.cs" Inherits="App.InfoGrid2.View.InputExcel.StepNew2" %>
...
<table align="center" style="width:400px;" border="0" >
    <tr>
        <td>
            <mi:TextBox runat="server" ID="tbxTableName" FieldLabel="目标表名" ReadOnly="true" />
