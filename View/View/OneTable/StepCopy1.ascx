<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepCopy1.ascx.cs" Inherits="App.InfoGrid2.View.OneTable.StepCopy1" %>
...
<table align="center" style="width:400px;" border="0" >
    ...
    <tr>
        <td style="padding: 20px; border: 1px solid #CCCCCC; background-color: #FFFFFF;">
            <mi:TextBox runat="server" ID="ExTableTB2" FieldLabel="内部表名" LabelAlign="Right" Placeholder="内部表的扩展名称" />
        </td>
    </tr>
    <tr>
        <td align="center">
