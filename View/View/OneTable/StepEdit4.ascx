<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepEdit4.ascx.cs" Inherits="App.InfoGrid2.View.OneTable.StepEdit4" %>
...
<%--                <mi:SelectColumn DataField="UI_TYPE_ID" HeaderText="界面控件" TriggerMode="None">
                ...
                <mi:GroupColumn HeaderText="锁行规则">
                    
                    <mi:SelectColumn DataField="LOCKED_FIELD" HeaderText="锁行字段" TriggerMode="UserInput" >
                    </mi:SelectColumn>
                    
                    <mi:BoundField DataField="LOCKED_RULE" HeaderText="锁行规则" />
                ...
                <mi:CheckColumn DataField="DELETE_RECYCLE" HeaderText="删除到回收站" Width="100" />
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Layout="Auto" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" RowLines="true" ColumnLines="true" StoreID="store1" 
            Sortable="false" Dock="Full" PagerVisible="false">
            <Columns>
                <mi:RowNumberer />
                <mi:RowCheckColumn />
...
--%>
                ...
                <mi:GroupColumn HeaderText="结构过滤">
                    <mi:BoundField DataField="FILTER_CATA_TABLE" HeaderText="表名" />
                    <mi:BoundField DataField="FILTER_CATA_FIELD" HeaderText="字段名" />
                    <mi:BoundField DataField="FILTER_CATA_IDFIELD" HeaderText="主键" />
                </mi:GroupColumn>

                <mi:TriggerColumn DataField="L_CODE" HeaderText="简单表达式" Width="600" ButtonType="More" OnButtonClick="showTextDialog(this)" />
