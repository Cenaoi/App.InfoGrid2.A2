<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepEdit3.ascx.cs" Inherits="App.InfoGrid2.View.OneView.StepEdit3" %>
        ...
        <mi:Tab runat="server" ID="tab1" Text="字段集" Scroll="None">
            ...
            <mi:Table runat="server" ID="table1" RowLines="true" ColumnLines="true" StoreID="store1" Sortable="false" Dock="Full" >
                <Columns>
                    ...
                    <mi:NumColumn DataField="FIELD_SEQ" HeaderText="排序" Format="0.00" />
                </Columns>
            </mi:Table>

        </mi:Tab>

        <mi:Tab runat="server" ID="tab2" Text="视图表属性" Scroll="None">
