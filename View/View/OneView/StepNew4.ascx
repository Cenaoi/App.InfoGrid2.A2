<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepNew4.ascx.cs" Inherits="App.InfoGrid2.View.OneView.StepNew4" %>
...
<form action="" id="form2" method="post" style="">
<mi:Store runat="server" ID="store1" Model="IG2_TMP_TABLECOL" IdField="IG2_TMP_TABLECOL_ID"
    SortText="FIELD_SEQ ASC,IG2_TMP_TABLECOL_ID ASC" >
