<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StepNew3.ascx.cs" Inherits="App.InfoGrid2.View.OneView.StepNew3" %>
...
<mi:Store runat="server" ID="store1" Model="IG2_TMP_TABLECOL" IdField="IG2_TMP_TABLECOL_ID" SortField="FIELD_SEQ" >
