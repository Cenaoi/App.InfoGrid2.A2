<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormOneEditPreview.ascx.cs" Inherits="App.InfoGrid2.View.OneForm.FormOneEditPreview" %>
...
<form action="" method="post">
    ...
    <mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="0" Padding="0">
        ...
        <mi:FormLayout runat="server" ID="HanderForm1" ItemWidth="300" PaddingTop="10" ItemLabelAlign="Right" Region="North"
    ...
    <% if (EC5.SystemBoard.EcContext.Current.User.Roles.Exist(EC5.IG2.Core.IG2Param.Role.BUILDER))
        { %>
    <!--设计师模式-->
    <div id="SwitchPanel" style="width:860px;height:40px;border: 1px solid #C0C0C0;background-color: #FFFFFF;">
        <div style="margin:8px 24px 8px 8px; text-align:right;">
            <mi:Button runat="server" ID="Button4" Text="流程设置" Command="GoFlowSetup" />

            <mi:Button runat="server" ID="Button6" Text="流程节点权限设置" Command="GoFlowFormSetup" />
            ...
            <mi:Button runat="server" ID="Button2" OnClick="ChangeDesignMode()" Text="切换设计模式" />
            <mi:Button runat="server" ID="Button5" OnClick="SvaeLocalItems()" Text="保存位置" />
    ...
    <div id="flow_menupanel" class="mi-panel mi-layer mi-panel-default mi-border-box mi-menu-panel" 
        ...
        <div  id="flow_list" class="mi-axis" style="display:none; overflow:auto;">
...
<script>
    ...
    function showDialgoForTable(owner) {
        ...
        console.debug("sssssssssss",owner);
        ...
        var urlStr = Mini2.urlAppend("/App/InfoGrid2/view/OneSearch/SelectPreview.aspx",{
            ...
            menu_Id: menuID,
            dialog_col: owner.dataField,
            ui_Type_id: 'PAGE',
            owner_page_id : pageid,

            main_table:record.name,
            main_row_id : record.getId(),
            ...
            methods:{
                ...
                delete_item:function(obj){
                    ...
                    Mini2.Msg.confirm("","是否要删除，删除不能恢复了！",function(){
                        ...
                        $.get("/View/Biz/Handle/UploaderFileHandle.ashx",{action:'DELETE_ITEM',biz_file_id:obj.BIZ_FILE_ID,'table_name':m_table_name,'row_id':m_row_id},function(result){
...
<script >
    ...
    */
                ...
                var win = Mini2.createTop('Mini2.ui.Window',{
                    ...
                    render: function () {
                        ...
                        $(btns).click(function(){
                            ...
                            var flowCode = $(this).attr('data-flow');
                            var curNodeCode = $(this).attr('data-node-code');
                            var curLineCode = $(this).attr('data-line-code');
                            var billCodeField = $(this).attr('data-bill-code-field');
    ...
    function flow_showStep(action_type, ud, cur_flow_code, cur_node_code, line_code,billCodeField, billType, extData){
...
<script>
    ...
    function ChangeDesignMode(){
        ...
        var url = Mini2.urlAppend('/App/InfoGrid2/View/OneForm/FormOneEditPreview.aspx',{
            ...
            if(Mini2.designMode()){
                ...
                targetEl.sortable({
                    ...
                    beforeStop:function(evt, ui){
                        var phd = $('.ui-sortable-highlight');

                        var lineEl = $(phd).prev('.mi-newline');

                        console.debug("lineEl = ", lineEl.length);
                ...
                //$(targetEl).sortable({
                //    connectWith: ".mi-box-target",
                //    handle : ".mi-form-item-label"
                //}).disableSelection();
            }
