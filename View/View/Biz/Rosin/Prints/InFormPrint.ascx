<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InFormPrint.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin.Prints.InFormPrint" %>
...
<div style="width:100%; height:600px;">
    ...
    <div id="printContent" style="  margin-left:auto;margin-right:auto; ">
        ...
        <div style="text-align:center;width:180mm; font-size:40px;">入库单</div>
