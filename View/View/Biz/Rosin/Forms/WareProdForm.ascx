<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WareProdForm.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin.Forms.WareProdForm" %>
...
<mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="0" Padding="0" Scroll="None">
...
<%--        <mi:ComboBox runat="server" ID="COL_5_tb" DataField="COL_5" FieldLabel="规格" TriggerMode="None" 
        ...
        <mi:TextBox runat="server" ID="COL_28_tb" DataField="COL_28" FieldLabel="等级(验收)" />
        <mi:TextBox runat="server" ID="COL_29_tb" DataField="COL_29" FieldLabel="厂家" />

        <mi:NumberBox runat="server" ID="COL_18_nb" DataField="COL_18" FieldLabel="应收数量" Required="true" />
        ...
        <mi:TabPanel runat="server" ID="detailTabPanel" Height="400" Region="Center" Dock="Full" ButtonVisible="false" Plain="true" >
            ...
            <mi:Tab runat="server" ID="tab1" Scroll="None" Text="码单">
                <mi:Toolbar runat="server" ID="toolbar1">
                    <mi:ToolBarButton Text="新建" OnClick="ser:storeMD1.Insert()" />
                    <mi:ToolBarButton Text="刷新" OnClick="ser:storeMD1.Refresh()" />
                    <mi:ToolBarHr />
                    <mi:ToolBarButton Text="删除" OnClick="ser:storeMD1.Delete()" BeforeAskText="确定删除选中的记录?" />
                </mi:Toolbar>
                <mi:Table runat="server" ID="tableProd1" Dock="Full" StoreID="storeMD1" PagerVisible="false" SummaryVisible="true" >
                    <Columns>
                        <mi:RowNumberer />
                        <mi:RowCheckColumn />
    ...
    function biz_mapping(owner, type_id, view_id, one_field) {
        ...
        function (responseText, textStatus) {
            ...
            if (model.count == 1) {
                ...
                var pWin = Mini2.getParentWindow();


                var win = pWin.Mini2.create('Mini2.ui.Window', {
                    mode: true,
                    text: '选择',
                    iframe: true,
                    width: 800,
