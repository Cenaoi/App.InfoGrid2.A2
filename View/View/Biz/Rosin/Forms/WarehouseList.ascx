<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WarehouseList.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin.Forms.WarehouseList" %>
...
<mi:Store runat="server" ID="store1" Model="UT_001" IdField="ROW_IDENTITY_ID" PageSize="20" LockedField="BIZ_SID" DeleteRecycle="true" ReadOnly="true" >
    ...
    <SummaryFields>
        <mi:SummaryField DataField="NUM_TOTAL" SummaryType="SUM" >
            <Filter>
                <mi:Param Name="BIZ_SID" DefaultValue="2" Logic=">=" />
            </Filter>
        </mi:SummaryField>
        <mi:SummaryField DataField="WEIGHT_TOTAL" SummaryType="SUM" >
            <Filter>
                <mi:Param Name="BIZ_SID" DefaultValue="2" Logic=">=" />
            </Filter>
        </mi:SummaryField>        
        <mi:SummaryField DataField="ITEM_TOTAL" SummaryType="SUM" >
            <Filter>
                <mi:Param Name="BIZ_SID" DefaultValue="2" Logic=">=" />
            </Filter>
        </mi:SummaryField>
...
<mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="40">
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" MinHeight="200" >
            <Columns>
                <mi:RowNumberer />
                <mi:RowCheckColumn />
                ...
                <mi:SelectColumn HeaderText="状态" DataField="BIZ_SID" Width="70" TriggerMode="None" >
                    <mi:ListItem Value="0" Text="草稿" />
                    <mi:ListItem Value="2" Text="已提交" />
                    <mi:ListItem Value="4" Text="已提交" />
                </mi:SelectColumn>
                <mi:BoundField HeaderText="单号" DataField="BILL_NO" />
                <mi:BoundField HeaderText="到货性质" DataField="DH_XZ" Width="70"  />
                <mi:BoundField HeaderText="客户名称" DataField="CLIENT_NAME" />

                <mi:NumColumn HeaderText="合计" DataField="ITEM_TOTAL" ItemAlign="Right"  Width="80" NotDisplayValue="0" SummaryType="SUM" />
                <mi:NumColumn HeaderText="数量" DataField="NUM_TOTAL" ItemAlign="Right" Width="80"  NotDisplayValue="0"  SummaryType="SUM" />
                <mi:NumColumn HeaderText="重量" DataField="WEIGHT_TOTAL" ItemAlign="Right" Width="80"  NotDisplayValue="0" SummaryType="SUM"  />
