<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PlanListBizF3.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin2.Plan.PlanListBizF3" %>
...
<mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="40">
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Toolbar ID="Toolbar1" runat="server">
            <mi:ToolBarButton Text="还原" Command="GoReset" />
            
        </mi:Toolbar>
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" JsonMode="Sample" >
            <Columns>
                <mi:RowNumberer />
                <mi:RowCheckColumn />
