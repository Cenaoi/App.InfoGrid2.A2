<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActualList.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin2.Actual.ActualList" %>
...
<mi:Store runat="server" ID="store1" Model="UT_016" IdField="ROW_IDENTITY_ID" PageSize="20" LockedField="BIZ_SID"
...
<%--                <mi:NumColumn HeaderText="合计" DataField="ITEM_TOTAL" ItemAlign="Right"  Width="80" NotDisplayValue="0" />--%>
                ...
                <mi:BoundField HeaderText="单位" DataField="PROD_NUM_UNIT" Width="80" />
                <mi:BoundField  HeaderText="抽检等级" DataField="CJ_LEVE" />
...
<%--                <mi:BoundField HeaderText="储存卡号" DataField="CCK_NO" />
                ...
                <mi:BoundField HeaderText="开单时间" DataField="DOC_CREATE_DATE" />
