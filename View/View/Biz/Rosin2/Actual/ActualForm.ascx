<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActualForm.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Rosin2.Actual.ActualForm" %>
...
<div runat="server" id="StoreSet">
    <mi:Store runat="server" ID="storeMain1" Model="UT_016" IdField="ROW_IDENTITY_ID" ReadOnly="true">
        <FilterParams>
    ...
    <mi:Store runat="server" ID="storeProd1" Model="UT_017_PROD" IdField="ROW_IDENTITY_ID" >
        <FilterParams>
            <mi:Param Name="ROW_SID" DefaultValue="0" Logic=">=" />
...
<mi:Viewport runat="server" ID="viewport1" Main="true" MarginTop="0" Padding="0">
    ...
    <mi:Toolbar runat="server" ID="mainToolbar1">
        ...
        <mi:ToolBarHr />
        <mi:ToolBarButton ID="PrintOutBtn" Text="出库单打印" Command="GoOutPrint" Visible="false" />
        <mi:ToolBarButton ID="PrintQrCodeBtn" Text="条码打印" Command="GoQrCodePrint" Visible="false" />
        <mi:ToolBarButton ID="PrintInBtn" Text="入库单打印" Command="GoInPrint" Visible="false" />
    ...
    <mi:FormLayout runat="server" ID="FormLayoutTop" ItemWidth="240" PaddingTop="10" StoreID="storeMain1"  Dock="Right" Top="40px"
                ItemLabelAlign="Right" Width="500px"  FlowDirection="LeftToRight" AutoSize="true" Position="Relative" Right="0px" Left="auto"  >   
             
        <mi:TextBox runat="server" ID="textBox4" DataField="DOC_CREATE_USER_TEXT" FieldLabel="开单人" ReadOnly="true" />
        ...
        <mi:TextBox runat="server" ID="textBox14" DataField="DOC_CHECK_USER_TEXT" FieldLabel="审核人" ReadOnly="true" />
        <mi:TextBox runat="server" ID="textBox6" DataField="DOC_CHECK_DATE" FieldLabel="审核时间" ReadOnly="true" />
        
    </mi:FormLayout>

    <mi:TabPanel runat="server" ID="tabPanel1" Dock="Full" Region="Center" UI="win10" ButtonVisible="false" TabLeft="8">
        <mi:Tab runat="server" ID="tab1" Text="常规信息" Scroll="None" >
            <mi:FormLayout runat="server" ID="HanderForm1" Dock="Top" MinHeight="300" ItemWidth="300" PaddingTop="10" StoreID="storeMain1" 
                ...
                <mi:TextBox runat="server" ID="textBox3" DataField="S_PROD_TEXT" FieldLabel="货物名称" ButtonType="More" Required="true"/>

                <mi:ComboBox runat="server" ID="ComboBox_CJ_LEVE" DataField="CJ_LEVE" FieldLabel="抽检等级" TriggerMode="None" Visible="false">
                ...
                <mi:TextBox runat="server" ID="car_no_tb" FieldLabel="车牌号/调度单号" DataField="O_CAR_NO" />
                <mi:DatePicker runat="server" ID="car_date_dp" FieldLabel="装车时间" DataField="O_CAR_DATE" />
            ...
            <mi:Panel runat="server" ID="panel2"  Dock="Full"  Padding="6" Scroll="None">
                ...
                <mi:Table runat="server" ID="table1" StoreID="storeProd1" Dock="Full" >
                    <Columns>
                        <mi:RowNumberer />
                        <mi:RowCheckColumn />
                        <mi:SelectColumn DataField="LOCK_SID" HeaderText="锁状态" StringItems="0=--;2=锁住" EditorMode="None" TriggerMode="None" Width="50" ItemAlign="Center">
                        </mi:SelectColumn>
...
<%--                        
        ...
        <mi:Tab runat="server" ID="tab2" Text="货物明细">
            ...
            <mi:FormLayout runat="server" ID="formLayout2" ItemWidth="300" PaddingTop="10" StoreID="storeMain1" 
                ...
                <div class="mi-newline" >
                    <div class="mi-newline-border2 mi-newline-text">计划单信息</div>
                </div>
                        
                <mi:TextBox runat="server" ID="DOC_UPDATE_DATE_tb" DataField="PLAN_BILL_NO" FieldLabel="计划单号" ReadOnly="true" />

                <div class="mi-newline" >
                    <div class="mi-newline-border2 mi-newline-text">更新信息</div>
                </div>

                <mi:TextBox runat="server" ID="textBox15" DataField="DOC_UPDATE_USER_TEXT" FieldLabel="更新人" ReadOnly="true" />
                <mi:TextBox runat="server" ID="textBox16" DataField="DOC_UPDATE_DATE" FieldLabel="更新时间" ReadOnly="true" />
