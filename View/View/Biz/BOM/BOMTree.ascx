<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BOMTree.ascx.cs" Inherits="App.InfoGrid2.View.Biz.BOM.BOMTree" %>
...
<mi:Viewport runat="server" ID="viewport1" Main="true">
    ...
    <mi:FormLayout runat="server" ID="FormLayout1" ItemWidth="600" ItemLabelAlign="Right" 
        Height="600" Dock="Full" Region="Center" SaveEnabled="true" >
                ...
                <mi:TriggerBox runat="server" ID="COL_7TB" FieldLabel="物料编号" DataField="COL_7" OnButtonClick="test()" ButtonType="More"/>
...
<script type="text/javascript">
    ...
    function test()
    {
        var urlStr = $.format("/App/InfoGrid2/view/OneSearch/SelectPreview.aspx?type=VIEW&viewId=823");
