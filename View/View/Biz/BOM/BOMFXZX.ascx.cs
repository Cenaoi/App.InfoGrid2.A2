...
{
    public partial class BOMFXZX : WidgetControl, IView
    {
        ...
        public void ClearBOM()
        {
            ...
            lmFilter102.And("ROW_IDENTITY_ID", ids, HWQ.Entity.Filter.Logic.In);
        ...
        public void btnChangeRowSid0_2()
        {
            ...
            catch (Exception ex)
            {
                ...
                log.Error(ex);
                EasyClick.Web.Mini.MiniHelper.Eval("ShowGif('分析错误了！')");
            }
