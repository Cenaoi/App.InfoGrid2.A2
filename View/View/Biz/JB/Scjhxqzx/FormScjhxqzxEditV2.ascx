<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormScjhxqzxEditV2.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JB.Scjhxqzx.FormScjhxqzxEditV2" %>
...
<%--            <mi:ToolBarHr />
        ...
        <mi:Table runat="server" ID="mainClientTable" Dock="Full" StoreID="StoreUT102"  PagerVisible="true" SummaryVisible="true" RowAltEnabled="false" ReadOnly="false"
            ...
            <Columns>
                ...
                <mi:BoundField HeaderText="客户方编号" DataField="COL_27" EditorMode="None" Width="80" Visible="false" />
                ...
                <mi:BoundField HeaderText="排摸个数" DataField="COL_8" EditorMode="None" Width="70" Visible="false"  ItemAlign="Right" />
                <mi:BoundField HeaderText="生产数量" DataField="COL_9" SummaryType="SUM" Width="70"  ItemAlign="Right" />
                <mi:BoundField HeaderText="当前库存数量" DataField="COL_10" SummaryType="SUM"  Width="90"  ItemAlign="Right" Visible="false" />
                ...
                <mi:BoundField HeaderText="用料说明" DataField="COL_12" EditorMode="None"  Width="180"  Visible="false" />
    ...
    <mi:TabPanel runat="server" ID="tabPanel1" Region="South" Dock="Bottom" Plain="True" Height="300" UI="win10" TabLeft="10" >
            ...
            <mi:Panel runat="server" ID="panelX1" Dock="Top" Scroll="None" Height="120" IsDelayRender="true">
                ...
                <mi:Table runat="server" ID="Table1" Dock="Full" StoreID="StoreUT103" PagerVisible="false"  Height="100"  IsDelayRender="true">
                    <Columns>
                        ...
                        <mi:BoundField HeaderText="排摸个数" DataField="COL_64" Width="70" EditorMode="None" Visible="false" />
                        ...
                        <mi:BoundField HeaderText="实需张数" DataField="COL_8"  SummaryType="SUM" EditorMode="None" Visible="false" Width="90" />
                        <mi:BoundField HeaderText="50KG生产个数" DataField="COL_18" Width="98" EditorMode="None" Visible="false" />
                        ...
                        <mi:BoundField HeaderText="是否植绒" DataField="COL_13" EditorMode="None" Width="70" Visible="false"  />
                        <mi:NumColumn HeaderText="损耗率" DataField="COL_112" Width="90"  EditorMode="None" />
        ...
        <mi:Tab runat="server" ID="tab2" Text="采购需求" Scroll="None" IsDelayRender="true">
            ...
            <mi:Table runat="server" ID="Table4" Dock="Full" StoreID="StoreUT216" PagerVisible="false" SummaryVisible="true" Height="160" IsDelayRender="true">
                <Columns>
                    ...
                    <mi:SelectColumn HeaderText="是否植绒" DataField="COL_13" TriggerMode="None" Visible="false" Width="70">
                    ...
                    <mi:NumColumn HeaderText="实需张数" DataField="COL_8"  SummaryType="SUM" Width="70" Visible="false" EditorMode="None" />                  
        ...
        <mi:Tab runat="server" ID="tab4" Text="领料需求" Scroll="None"  IsDelayRender="true">
            ...
            <mi:Table runat="server" ID="Table5" Dock="Full" StoreID="StoreUT103" PagerVisible="false" SummaryVisible="true" Height="160" ReadOnly="true" IsDelayRender="true">
                <Columns>
                    ...
                    <mi:NumColumn HeaderText="实需张数" DataField="COL_8"  SummaryType="SUM" Width="70" EditorMode="None" Visible="false" />
                    
                    <mi:NumColumn HeaderText="50KG生产个数" DataField="COL_18" Width="100" EditorMode="None" Visible="false" />
...
<script type="text/javascript">
    ...
    function RowEdit(view, cell, recordIndex, cellIndex, e, record, row) {
        ...
        EcView.show("/App/InfoGrid2/View/Biz/JLSLBZ/Currency/FormXssczlV2.aspx?id=" + headId, "车间生产指令单");
