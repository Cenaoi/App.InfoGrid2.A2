...
{
    public partial class FormScjhxqzxEditV2 : WidgetControl, IView
    {
        ...
        {
            StoreUT102.CurrentChanged += StoreUT102_CurrentChanged;
        ...
        void StoreUT103_CurrentChanged(object sender, EasyClick.Web.Mini2.ObjectEventArgs e)
        {
            ...
            foreach (var item in lmList118)
            {
                ...
                sb.Append($"{item["COL_11"]}:{item["COL_9"]}     ");
        ...
        public void GoAutoLink()
        {
            ...
            try
            {
                ...
                Toast.Show(string.Format("共更新 {0} 条记录", count));
            }
            catch (Exception ex)
            {
        ...
        public void btnChangeRowSid0_2()
        {
            ...
            try
            {
                ...
                stepPath = dbccFactory.Updated(this.StoreUT103, lm);
