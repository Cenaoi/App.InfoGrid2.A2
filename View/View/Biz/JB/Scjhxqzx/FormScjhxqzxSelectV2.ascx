<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormScjhxqzxSelectV2.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JB.Scjhxqzx.FormScjhxqzxSelectV2" %>
...
<%--            <mi:ToolBarHr />
        ...
        <mi:Table runat="server" ID="mainClientTable" Dock="Full" StoreID="StoreUT102"  PagerVisible="true" SummaryVisible="true" RowAltEnabled="false" ReadOnly="false"
            ...
            <Columns>
                ...
                <mi:BoundField HeaderText="当前库存数量" DataField="COL_10" SummaryType="SUM"  Width="90" Visible="false"   ItemAlign="Right" />
