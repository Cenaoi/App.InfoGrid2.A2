...
{
    public partial class FormGYCDZD : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >供应商对账单</span>";
            }
        }
        ...
        public void ManageTemplate()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = "/App/InfoGrid2/View/PrintTemplate/ManageTemplateDZD.aspx?id=1000002";
        ...
        public void btnPrint()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = $"/App/InfoGrid2/View/PrintTemplate/PrintTemplateDZD.aspx?id=1000002&name={name}&code={code}&begTime={begTime.ToString("yyyy - MM - dd")}&endTime={endTime.ToString("yyyy - MM - dd")}";
