<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KHMXJDD.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.KHMXJDD" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" >
            <Columns>
                ...
                <mi:BoundField HeaderText="摘要" DataField="ABSTRACT"  Width="350"  />
