<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GYSMXJDD.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.GYSMXJDD" %>
         ...
         <mi:SearchFormLayout runat="server" ID="searchForm1" StoreID="store1"  Height="30">
                ...
                <mi:DateRangePicker ID="DateRangePicker1" runat="server"  FieldLabel="到期日期" ColSpan="2" />
                 ...
                 <mi:ComboBox runat="server" ID="cbmCOL_30" FieldLabel="单据类型" CheckedMode="Multi" >
                    <mi:ListItem  Text="采购单货单" Value="采购单货单"/>
                    <mi:ListItem  Text="采购退货单" Value="采购退货单"/>
                    <mi:ListItem  Text="委外加工收货单" Value="委外加工收货单"/>
                    <mi:ListItem  Text="付款单" Value="付款单"/>
                    <mi:ListItem  Text="预付款单" Value="预付款单"/>
                    <mi:ListItem  Text="供应商调整单" Value="供应商调整单"/>
                </mi:ComboBox>      
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" >
            <Columns>
                ...
                <mi:BoundField HeaderText="摘要" DataField="ABSTRACT"  Width="250"  />
                ...
                <mi:BoundField HeaderText="备注" DataField="REMARKS"  Width="250"  />
