<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormGYSDJHZD.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.FormGYSDJHZD" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" >
            <Columns>
                ...
                <mi:NumColumn HeaderText="期末-实际应收款" DataField="END_AARECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')"  Width="100"  Format="0.##"  />
