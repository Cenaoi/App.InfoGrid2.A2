...
namespace App.InfoGrid2.View.Biz.Financial
{
    ...
    /// 供应商单据汇总校对单
    /// </summary>
    public partial class GYSDJHZJDD : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >供应商单据汇总校对单</span>";
            }
        }
        ...
        void InitData()
        {
            try
            {
                string path = "Biz/Financial/GYSDJHZJDD.xml";
            ...
            catch (Exception ex)
            {
                ...
                Error404.Send("供应商单据汇总校对单", "配置文件读取出错了，请联系系统管理员！");
        ...
        public void ManageTemplate()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = "/App/InfoGrid2/View/PrintTemplate/ManageTemplateDZD.aspx?id=1000007";
        ...
        public void btnPrint()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = $"/App/InfoGrid2/View/PrintTemplate/PrintTemplateDZD.aspx?id=1000007&name={name}&code={code}&begTime={begTime.ToString("yyyy - MM - dd")}&endTime={endTime.ToString("yyyy - MM - dd")}";
