<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormCWTJ.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.FormCWTJ" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" >
            <Columns>
                ...
                <mi:NumColumn HeaderText="数量" DataField="F_NUMBER" SummaryType="SUM"  Format="0.##" Width="80"  />
                <mi:NumColumn HeaderText="单价" DataField="F_PRICE"  Width="80" Format="0.##"  />
                <mi:NumColumn HeaderText="应收款" DataField="RECEIVABLES" SummaryType="SUM" Format="0.##" Width="80"  />
                ...
                <mi:BoundField HeaderText="仓库编码" DataField="WAREHOUSE_CODE" Visible="false"  Width="70"  />
