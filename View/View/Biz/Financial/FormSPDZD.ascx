<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormSPDZD.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.FormSPDZD" %>
...
<script>
    function onBtnClick() {
        ...
        var url = "/App/InfoGrid2/View/OneSearch/SelectPreview.aspx?viewId=901";
        ...
        win.formClosed(function (e) {
            ...
            $("#widget1_I_tbxID").val(e.row.COL_1);  ///产品编码
