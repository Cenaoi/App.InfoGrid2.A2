...
namespace App.InfoGrid2.View.Biz.Financial
{
    ...
    /// 供应商单据汇总单
    /// </summary>
    public partial class FormGYSDJHZD : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.headLab.Value = "<span class='page-head' >供应商单据汇总对账单</span>";
            }
        }
        ...
        void InitData()
        {
            try
            {
                ...
                string path = "Biz/Financial/FormGYSDJHZD.xml";
        ...
        public void btnSelect()
        {
            try
            {
                ...
                {
                    rece += item.Get<decimal>("COL_26");
                    pre_rece += item.Get<decimal>("COL_27");
                }
                ...
                {
                    ///这是期末数的应收
                    decimal end_rece = rece + item.Get<decimal>("COL_26");
                    ///这是期末数的预收款
                    decimal end_pre_rece = pre_rece + item.Get<decimal>("COL_27");
        ...
        public void ManageTemplate()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = "/App/InfoGrid2/View/PrintTemplate/ManageTemplateDZD.aspx?id=1000003";
        ...
        public void btnPrint()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = $"/App/InfoGrid2/View/PrintTemplate/PrintTemplateDZD.aspx?id=1000003&name={name}&code={code}&begTime={begTime.ToString("yyyy - MM - dd")}&endTime={endTime.ToString("yyyy - MM - dd")}";
