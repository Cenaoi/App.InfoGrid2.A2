...
namespace App.InfoGrid2.View.Biz.Financial
{
    ...
    public partial class KHMXJDD : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >客户明细校对单</span>";
            }
        }
        ...
        public void btnSelect()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(tbWarehouse.Value))
                {
                    ...
                    lmFilter181.And("COL_43", codes.ToString(), Logic.In);
                }
        ...
        public void ManageTemplate()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = "/App/InfoGrid2/View/PrintTemplate/ManageTemplateDZD.aspx?id=1000010";
        ...
        public void btnPrint()
        {
            ...
            //那个ID是随便给的一个唯一的ID
            string urlStr = $"/App/InfoGrid2/View/PrintTemplate/PrintTemplateDZD.aspx?id=1000010&name={name}&code={code}&begTime={begTime.ToString("yyyy-MM-dd")}&endTime={endTime.ToString("yyyy-MM-dd")}"; 
