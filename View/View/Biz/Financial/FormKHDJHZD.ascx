<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormKHDJHZD.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Financial.FormKHDJHZD" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" ReadOnly="true" SummaryVisible="true" >
            <Columns>
                ...
                <mi:NumColumn HeaderText="期初-应收款" DataField="BEG_RECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')" Format="0.##"  Width="90"  />
                <mi:NumColumn  HeaderText="期初-预收款" DataField="BEG_PRE_RECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')" Format="0.##" Width="90"   />
                <mi:NumColumn HeaderText="期初-实际应收" DataField="BEG_AARECEIVABLE" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')" Format="0.##" Width="90"   />
                <mi:BoundField HeaderText="摘要" DataField="ABSTRACT"  Width="180"  />
                <mi:NumColumn HeaderText="数量" DataField="F_NUMBER"  SummaryType="SUM" Format="0.00" Width="80"   />
                <mi:NumColumn HeaderText="应收款" DataField="RECEIVABLES" SummaryType="SUM"  Format="0.00"    Width="80"  />
                <mi:NumColumn HeaderText="预收款" DataField="PRE_RECEIVABLES" SummaryType="SUM"  Format="0.##"    Width="80"  />
                <mi:NumColumn HeaderText="期末-应收款" DataField="END_RECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')"  Format="0.##"  Width="90"  />
                <mi:NumColumn HeaderText="期末-预收款" DataField="END_PRE_RECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')"  Format="0.##"  Width="90"  />
                <mi:NumColumn HeaderText="期末-实际应收款" DataField="END_AARECEIVABLES" Renderer="Mini2.DisplayRule.getRule('SET_COLOR')" Format="0.##" Width="90"   />
                <mi:BoundField HeaderText="备注" DataField="REMARKS"  Width="190"  />
