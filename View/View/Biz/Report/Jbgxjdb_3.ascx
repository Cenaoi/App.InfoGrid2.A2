<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Jbgxjdb_3.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Report.Jbgxjdb_3" %>
...
<script>
    ...
    function setChart(title_list,series_list){
