<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Jbgxjdb_8.ascx.cs" Inherits="App.InfoGrid2.View.Biz.Report.Jbgxjdb_8" %>
...
<mi:Viewport runat="server" ID="viewport1" Main="true">
    ...
    <mi:Panel runat="server" Region="North" Height="800" >

    <div id="main_chart_5" style="height:300px;width:100%;margin-top:30px;" class="mi-newline"></div>

    <div id="main_chart_6" style="height:300px;width:100%;margin-top:30px;" class="mi-newline"></div>
...
<script>
    ...
    $(function(){
        ...
        var chart_data5 = <%=chart_data5%>;
           
        setColumnChart5("main_chart_5",chart_data5);

        var chart_data6 = <%=chart_data6%>;
           
        setColumnChart6("main_chart_6",chart_data6);    
...
<script>
    ...
    function setColumnChart5(main_columnChart, chart_data) {
        ...
        myColumnChart.on("click", function (params) {
            ...
            EcView.show("/App/InfoGrid2/View/ReportBuilder/ReportPreviewV2.aspx?id=1958");
...
<script>
    ...
    function setColumnChart6(main_columnChart, chart_data) {
        ...
        myColumnChart.on("click", function (params) {
            ...
            EcView.show("/App/InfoGrid2/View/ReportBuilder/ReportPreviewV2.aspx?id=1952");
