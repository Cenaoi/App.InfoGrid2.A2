...
<mi:Viewport runat="server" ID="viewport1" Padding="4" ItemMarginRight="6">
    ...
    <mi:Panel runat="server" ID="TopPanel" Region="North" Scroll="None" >
        ...
        <mi:FormLayout runat="server" ID="mainForm" ItemWidth="300"  FlowDirection="LeftToRight" ItemLabelAlign="Right" Dock="Full"
    ...
    <mi:Panel runat="server" ID="Panel1" Region="North" Scroll="None" Height="200" >
        ...
        <mi:Table runat="server" ID="mainClientTable" Dock="Full" StoreID="StoreUT102"  PagerVisible="false" SummaryVisible="true">
            <Columns>
                ...
                <mi:NumColumn HeaderText="当前库存数量" DataField="COL_10" SummaryType="SUM" Width="90" EditorMode="None"  Format="0.##" />
                ...
                <mi:BoundField HeaderText="用料说明" DataField="COL_54" Width="180" EditorMode="None" />
                <mi:BoundField HeaderText="用料说明" DataField="COL_12" Width="180" EditorMode="None" />
                <mi:BoundField HeaderText="用料说明" DataField="COL_12" Width="180" EditorMode="None" />
        ...
        <mi:Panel runat="server" ID="panelXX1" Dock="Top" Scroll="None" Height="110">
            ...
            <mi:Table runat="server" ID="Table103" Dock="Full" StoreID="StoreUT103" PagerVisible="false" Height="160" >
                <Columns>
                    ...
                    <mi:NumColumn HeaderText="密度" DataField="COL_5" Width="70" EditorMode="None" Format="0.##" />
                    <mi:NumColumn HeaderText="厚度C" DataField="COL_17" Width="70" EditorMode="None" Format="0.##" />
                    <mi:NumColumn HeaderText="宽度MM" DataField="COL_4" Width="70" EditorMode="None" Format="0.##" />
                    <mi:NumColumn HeaderText="板长M" DataField="COL_6" Width="70" Format="0.##" />
                    ...
                    <mi:NumColumn HeaderText="预拉板数" DataField="COL_72"  SummaryType="SUM" Width="70"  EditorMode="None" Format="0.##"/>
                    <mi:NumColumn HeaderText="需拉板数" DataField="COL_8"  SummaryType="SUM" Width="70"  EditorMode="None" Format="0.##" />
        ...
        <mi:Panel runat="server" ID="panel3" Dock="Top" Scroll="None" Height="110">
            ...
            <mi:Table runat="server" ID="Table106" Dock="Full" StoreID="StoreUT106" Height="100" PagerVisible="false">
                <Columns>
                    ...
                    <mi:BoundField HeaderText="刀具名称" DataField="COL_1" Width="100" EditorMode="None" />
                    <mi:BoundField HeaderText="新旧" DataField="COL_26" Width="45" />
                    <mi:BoundField HeaderText="数量" DataField="COL_9"  Width="70" />
                    <mi:SelectColumn HeaderText="来源" DataField="COL_2" Width="100"  >
                        <mi:ListItem Text="自制" Value="自制" />
