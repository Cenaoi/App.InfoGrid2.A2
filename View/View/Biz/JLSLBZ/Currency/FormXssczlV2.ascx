<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormXssczlV2.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JLSLBZ.Currency.FormXssczlV2" %>
...
<%--            <mi:ToolBarButton Text="引入生产计划" OnClick="showDialgoFor1505(this)" />
            ...
            <mi:ToolBarButton Text="引入项目定制订单" OnClick="showDialgoFor2155(this)" />
            <mi:ToolBarButton Text="引入项目量产订单" OnClick="showDialgoFor2155(this)" />
   <%--         <mi:ToolBarButton Text="TD云智能工艺分析" Command="AutoInputData"/>--%>
            <mi:ToolBarButton Text="获取标准BOM" Command="GoGetStandardBOM" />
...
<%--            <mi:ToolBarButton Text="需求量计算" Command="AutoCalculation" />--%>
            ...
            <mi:ToolBarButton Text="导出Excel" Command="GoExport" />
        ...
        <mi:FormLayout runat="server" ID="mainForm" ItemWidth="300"  FlowDirection="LeftToRight" ItemLabelAlign="Right" Dock="Full" PaddingTop="4" >
            ...
            <mi:ComboBox runat="server" ID="comboBox5" FieldLabel="产品模式" DefaultValue="101" Width="180" TriggerMode="None" >
                <mi:ListItem Value="101" Text="定制件" />
                <mi:ListItem Value="102" Text="量产件" />
            </mi:ComboBox>
    ...
    <mi:Panel runat="server" ID="Panel1" Region="North" Scroll="None" Height="250" >
        ...
        <mi:Table runat="server" ID="mainClientTable" Dock="Full" StoreID="StoreUT102"  PagerVisible="false" SummaryVisible="true">
            <Columns>
                ...
                <mi:BoundField HeaderText="项目编码" DataField="COL_104" Width="90" EditorMode="None"   />
                <mi:BoundField HeaderText="项目名称" DataField="COL_105" Width="100" EditorMode="None"   />
                ...
                <mi:BoundField HeaderText="产品模式" DataField="COL_100" Width="180" EditorMode="None"   />

<%--                <mi:BoundField HeaderText="产品模式编码" DataField="COL_101" Width="180" EditorMode="None"   />
                <mi:NumColumn HeaderText="单个用量" DataField="COL_93" Width="70"  />--%>
...
<%--           增加下列字段:
    ...
    <mi:Panel runat="server" Region="Center" ID="centerPanel1" ItemClass="mi-box-item" Layout="VBox" Scroll="Vertical">
        ...
        <mi:Panel runat="server" ID="panelXX1" Dock="Top" Scroll="None" Height="230">
            ...
            <mi:Table runat="server" ID="Table103" Dock="Full" StoreID="StoreUT103" PagerVisible="false" Height="160" >
                <Columns>
                    ...
                    <mi:BoundField HeaderText="使用车间" DataField="COL_114"    />

                    <mi:NumColumn HeaderText="计划用量" DataField="COL_10" Width="70" Visible="false"  EditorMode="None"  />
                    
                    <mi:NumColumn HeaderText="实际用量" DataField="COL_12" Width="90"  EditorMode="None" Visible="false" />

                    <mi:BoundField HeaderText="产品模式" DataField="COL_102" Width="180" EditorMode="None" Visible="false"   />
                    <mi:BoundField HeaderText="产品模式编码" DataField="COL_103" Width="180" EditorMode="None"  Visible="false"   />
                    <mi:BoundField HeaderText="项目编码" DataField="COL_110" Visible="false"   />
                    <mi:BoundField HeaderText="项目名称" DataField="COL_111" Visible="false"   />

                    <mi:NumColumn HeaderText="物料单量" DataField="COL_93" Width="90"  EditorMode="None" />
                    <mi:NumColumn HeaderText="数量" DataField="COL_10" Width="90"  EditorMode="None" />

                    <mi:NumColumn HeaderText="损耗率" DataField="COL_112" Width="90" />
                    <mi:NumColumn HeaderText="损耗" DataField="COL_11" Width="90"    />

                    <mi:NumColumn HeaderText="实需量" DataField="COL_12" Width="90"  EditorMode="None" />
        ...
        <mi:Panel runat="server" ID="panel2" Dock="Top" Scroll="None" Height="230">
            ...
            <mi:Table runat="server" ID="Table105" Dock="Full" StoreID="StoreUT105" Height="200" PagerVisible="false">
                <Columns>
                    <mi:RowNumberer />
                    <mi:RowCheckColumn />
        ...
        <mi:Panel runat="server" ID="panel3" Dock="Top" Scroll="None" Height="230">
        ...
        <mi:Panel runat="server" ID="panel4" Dock="Top" Scroll="None" Height="230">
        ...
        <mi:Table runat="server" ID="Table104" Dock="Full" StoreID="StoreUT104" PagerVisible="false" SummaryVisible="true" Height="160">
            <Columns>
                ...
                <mi:BoundField HeaderText="生产车间" DataField="COL_72" Width="150" />
...
//        }
    ...
    //引入项目定制订单、引入项目量产订单 按钮点击事件
    function showDialgoFor2155(owner) {
        ...
        win.formClosed(function (e) {
            ...
            widget1.subMethod($('form:first'), {
                action: 'GoImportProductionPlan_115',
                actionPs: e.ids
            });
