...
{
    public partial class ArchivesTree : WidgetControl, IView
    {
        ...
        void TreePanel1_Selected(object sender, EventArgs e)
        {
            ...
            int viewId = WebUtil.QueryInt("id");
            ...
            int menuID = WebUtil.QueryInt("menu_id", 134);
            ...
            List<string> ids = new List<string>();
             ...
             MiniPager.Redirect("iform1", string.Format("/app/infogrid2/view/OneView/ViewPreview.aspx?id={2}&menu_id={1}&StoreID={0}", sb.ToString(), menuID, viewId));
        ...
        private void InitData()
        {
            ...
            foreach(var item in nodeList)
            {
                ...
                {
                    log.Debug("仓库上级节点没有  仓库名称："+item.Get<string>("COL_2"),ex);
                    continue;
                }
