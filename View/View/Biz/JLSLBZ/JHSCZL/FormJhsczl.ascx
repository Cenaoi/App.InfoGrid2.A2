<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormJhsczl.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JLSLBZ.JHSCZL.FormJhsczl" %>
...
<mi:Store runat="server" ID="StoreUT102" Model="UT_102" IdField="ROW_IDENTITY_ID" DeleteRecycle="true">
    ...
    <InsertParams>
        <mi:QueryStringParam Name="COL_13" QueryStringField="id" />
        <mi:Param Name="COL_16" DefaultValue="胶盒成品" />
    </InsertParams>
    <SummaryFields>
...
<script type"text/javascript">
    ...
    function showDialgoForTable(owner) {
        ...
        var filter2 = '[{field:"UT_091.COL_1",logic:"=",value:"胶盒成品"}]';
