...
{
    public partial class FormJhsczl : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >胶盒生产指令单</span>";
        ...
        public void Print(string PrintCode)
        {
            ...
            try
            {
                ...
                string patha = Server.MapPath("/PrintTemplate/胶盒施工单-OK.xls");
