<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormXssczl_V3.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JLSLBZ.ZLD.FormXssczl_V31" %>
...
<mi:Store runat="server" ID="StoreUT102" Model="UT_102" IdField="ROW_IDENTITY_ID" DeleteRecycle="true">
    ...
    <InsertParams>
        <mi:QueryStringParam Name="COL_13" QueryStringField="id" />
        <mi:Param Name="COL_16" DefaultValue="印刷成品" />
    </InsertParams>
    <SummaryFields>
...
<mi:Viewport runat="server" ID="viewport1" Padding="4" ItemMarginRight="6">
    ...
    <mi:Panel runat="server" ID="TopPanel" Region="North" Scroll="None" >
        ...
        <mi:FormLayout runat="server" ID="mainForm" ItemWidth="210"  FlowDirection="LeftToRight" ItemLabelAlign="Right" Dock="Full"
            ...
            <mi:ComboBox runat="server" ID="comboBox2" FieldLabel="单据类型" DefaultValue="正常生产单" Width="80" TriggerMode="None">
                <mi:ListItem Value="模板" Text="模板" />
                <mi:ListItem Value="正常生产单" Text="正常生产单" />
            </mi:ComboBox>
            <mi:ComboBox runat="server" ID="comboBox1" FieldLabel="生产模式" DefaultValue="自制" Width="70" TriggerMode="None">
            ...
            <mi:ComboBox runat="server" ID="comboBox4" FieldLabel="混合排版" DefaultValue="单客户" Width="45" TriggerMode="None" >
    ...
    <mi:Panel runat="server" ID="Panel1" Region="North" Scroll="None" Height="200" >
        ...
        <mi:Table runat="server" ID="mainClientTable" Dock="Full" StoreID="StoreUT102"  PagerVisible="false" SummaryVisible="true">
            <Columns>
                ...
                <mi:BoundField HeaderText="订单号" DataField="COL_2" Width="70" />
                <mi:TriggerColumn HeaderText="产品编号" DataField="COL_3" Width="90" ButtonClass="mi-icon-more" 
                    OnButtonClick="showDialgoForTable_102(this,'VIEW',723)" 
                    OnMaping="mapping_103(this,'VIEW',723,'COL_1')" 
                    ...
                    <MapItems>
                        ...
                        <mi:MapItem SrcField="COL_1" TargetField="COL_3" Remark="产品编号" />
                        <mi:MapItem SrcField="COL_2" TargetField="COL_4" Remark="产品名称" />
                        <mi:MapItem SrcField="COL_3" TargetField="COL_5" Remark="规格" />
                        <mi:MapItem SrcField="COL_4" TargetField="COL_6" Remark="计量单位" />
                        <mi:MapItem SrcField="COL_5" TargetField="COL_8" Remark="排摸个数" />
                        <mi:MapItem SrcField="COL_9" TargetField="COL_32" Remark="单价" />
                        <mi:MapItem SrcField="COL_25" TargetField="COL_27" Remark="客户方编号" />
                    </MapItems>
                </mi:TriggerColumn>
                 <mi:TriggerColumn HeaderText="产品名称" DataField="COL_4" Width="180" ButtonClass="mi-icon-more" 
                    OnButtonClick="showDialgoForTable_102(this,'VIEW',723)" 
                    OnMaping="mapping_103(this,'VIEW',723,'COL_2')" 
                    Tag='{"type_id":"VIEW","view_id":723,"table_name":"UT_082","owner_table_id":213}' >
                    <MapItems>
                        <mi:MapItem SrcField="ROW_IDENTITY_ID" TargetField="COL_42" Remark="产品ID" />
                        <mi:MapItem SrcField="COL_1" TargetField="COL_3" Remark="产品编号" />
                ...
                <mi:NumColumn HeaderText="排摸个数" DataField="COL_8"  Width="70" SummaryType="SUM" Format="0.##" />
                <mi:NumColumn HeaderText="生产数量" DataField="COL_9" SummaryType="SUM" Width="70" Format="0.##"  />
  <%--          <mi:NumColumn HeaderText="当前库存数量" DataField="COL_10" SummaryType="SUM" Width="90" EditorMode="None" />--%>
                <mi:DateColumn HeaderText="计划完工时间" DataField="COL_11" Width="90" />
                

                
                <mi:BoundField HeaderText="备注" DataField="COL_26" Width="200" />
                <mi:BoundField HeaderText="用料说明" DataField="COL_12" Width="180" EditorMode="None" />
    ...
    <mi:Panel runat="server" Region="Center" ID="centerPanel1" ItemClass="mi-box-item" Layout="VBox" Scroll="Vertical">
        ...
        <mi:Panel runat="server" ID="panelXX1" Dock="Top" Scroll="None" Height="110">
            ...
            <mi:Table runat="server" ID="Table103" Dock="Full" StoreID="StoreUT103" PagerVisible="false" Height="160" >
                <Columns>
                    ...
                    <mi:NumColumn HeaderText="密度" DataField="COL_5" Width="60" EditorMode="None" Format="0.##" />
                    <mi:NumColumn HeaderText="厚度C" DataField="COL_17" Width="60" EditorMode="None" Format="0.##" />
                    <mi:NumColumn HeaderText="宽度MM" DataField="COL_4" Width="60" EditorMode="None" Format="0.##" />

                    <mi:NumColumn HeaderText="板长M" DataField="COL_6" Width="45" Visible="false" Format="0.##" />
                    <mi:NumColumn HeaderText="长度MM" DataField="COL_19" Width="60" Format="0.##" />
                   <mi:NumColumn HeaderText="排摸个数" DataField="COL_64" Width="70" EditorMode="None" Visible="false" Format="0.##" />
                   <mi:NumColumn HeaderText="生产个数" DataField="COL_65"  Width="100" EditorMode="None" Visible="false" Format="0.##" />

                    <mi:NumColumn HeaderText="计划张数" DataField="COL_7"  SummaryType="SUM" Width="90" Visible="false" Format="0.##" />
                    <mi:NumColumn HeaderText="损耗张数" DataField="COL_11"  Width="70" Format="0.##" />
                    <mi:NumColumn HeaderText="实需张数" DataField="COL_8"  SummaryType="SUM" Width="70" EditorMode="None" Format="0.##" />
                    
                    <mi:NumColumn HeaderText="50KG生产个数" DataField="COL_18" Width="98" EditorMode="None" />
                    ...
                    <mi:NumColumn HeaderText="计划用量" DataField="COL_10" Width="70" Visible="false" Format="0.##" />
                    
                    <mi:NumColumn HeaderText="实际用量" DataField="COL_12" Width="90" EditorMode="None" Format="0.##" />
        ...
        <mi:Panel runat="server" ID="panel3" Dock="Top" Scroll="None" Height="110">
            ...
            <mi:Table runat="server" ID="Table106" Dock="Full" StoreID="StoreUT106" Height="100" PagerVisible="false">
                <Columns>
                    <mi:RowNumberer />
                    <mi:RowCheckColumn />
                    <mi:TriggerColumn HeaderText="机器编码" DataField="COL_27" OnButtonClick="showDialgoForTable_102(this,'VIEW',710)" ButtonClass="mi-icon-more"  Width="90"
                         OnMaping="mapping_103(this,'VIEW',710,'COL_3')"
                        Tag='{"type_id":"VIEW","view_id":710,"table_name":"UT_108","owner_table_id":237}'                         >
                        <MapItems>
                    ...
                    <mi:BoundField HeaderText="机器名称" DataField="COL_1" Width="180" EditorMode="None" />
                    ...
                    <mi:BoundField HeaderText="存放位置" DataField="COL_39" Width="100" />
        ...
        <mi:Table runat="server" ID="Table104" Dock="Full" StoreID="StoreUT104" PagerVisible="false" SummaryVisible="true" Height="160">
            <Columns>
                ...
                <mi:NumColumn HeaderText="单个用量" DataField="COL_5" Width="70" Visible="false" Format="0.##" />
                ...
                <mi:NumColumn HeaderText="实需产量" DataField="COL_9" Width="70" EditorMode="None" Format="0.##" />
                <mi:BoundField HeaderText="备注" DataField="COL_10" Width="200" />
            </Columns>
        </mi:Table>
        </mi:Panel>
...
<script type"text/javascript">
    ...
    function showDialgoForTable(owner) {
        ...
        var filter2 = '[{field:"UT_245.COL_1",logic:"=",value:"印刷成品"}]';
