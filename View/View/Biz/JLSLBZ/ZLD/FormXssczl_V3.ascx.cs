...
{
    public partial class FormXssczl_V31 : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >印刷指令单</span>";
        ...
        void StoreUT103_Updating(object sender, ObjectCancelEventArgs e)
        {
            ...
            if (!model.IsNull("COL_4") && !model.IsNull("COL_5") && !model.IsNull("COL_17") && !model.IsNull("COL_19") && !model.IsNull("COL_8") && !model.IsNull("COL_9"))
            {
                ...
                {
                    ///    实际用量 = (密度 X   (厚度/100)  X 宽度  X (长度/1000)   X 实需张数  ) / 1000
                    decimal COL_12 = (COL_5 * (COL_17 / 100m) * col_4 * (COL_19 / 1000m) * COL_8) / 1000;
            ...
            if (!model.IsNull("COL_17") && !model.IsNull("COL_5") && !model.IsNull("COL_19") && !model.IsNull("COL_4"))
            {
                ...
                model["COL_18"] = Math.Floor(x);
                this.StoreUT103.SetRecordValue(e.SrcRecord.Id, "COL_18", Math.Floor(x));
            }
        ...
        void StoreUT104_Updating(object sender, ObjectCancelEventArgs e)
        {
            ...
            if (unit == "个")
            {
                model["COL_7"] = totalCol9;
            }
            else if (unit == "张")
            {
                decimal num = totalCol9 / totalCol8;
        ...
        void StoreUT103_Inserting(object sender, ObjectCancelEventArgs e)
        {
            ...
            if (totalCol8 != 0)
            {
                model["COL_7"] = totalCol9 / totalCol8;
            }
        ...
        private void InitData()
        {
            ...
            this.comboBox4.Value = IfUtil.NotBlank(model["COL_12"], "单客户"); //混合排版
        ...
        public void Print(string PrintCode)
        {
            ...
            try
            {
                ...
                string patha = Server.MapPath("/PrintTemplate/印刷施工单-OK.xls");

                SheetPro sp = nopiEx.ReadExcel(patha);
                ///设置标题
                SetHead(sp, model, col_2);
                ///设置数据
                SetData(sp);
        ...
        private void SetHead(SheetPro sp, LModel model, string col_2)
        {
            ...
            string ROW_AUTHOR_ORG_CODE = IfUtil.NotBlank(model["COL_11"], "");///创建人
        ...
        private void SetData(SheetPro sp)
        {
            try
            {
                ...
                RowProCollection rpc3 = rpc3 = new RowProCollection();
        ...
        private RowProCollection CreateUT103Cell(SheetPro sp)
        {
            ...
            try
            {
                ...
                foreach (LModel item in models)
                {
                    ...
                    ///材料规格
                    string ProSpecifications = IfUtil.NotBlank(item["COL_3"], "");
                    ///排摸总个数
                    ...
                    //计划张数
                    string col_7 = IfUtil.NotBlank(item["COL_7"], "");
                    ...
                    rp.cellPro[1].Value = ProName;
                    rp.cellPro[4].Value = ProSpecifications;
                    rp.cellPro[5].Value = col_64;
                    rp.cellPro[6].Value = col_7;
                    rp.cellPro[8].Value = col_8;
                    rp.cellPro[9].Value = col_9;
                    rp.cellPro[10].Value = col_12;
        ...
        private RowProCollection CreateUT104Cell3(SheetPro sp)
        {
            ...
            try
            {
                ...
                foreach (LModel item in models)
                {
                    ...
                    rp.cellPro[4].Value = col_9;
                    rp.cellPro[5].Value = col_8;
                    rp.cellPro[6].Value = col_6;
                    rpList.Add(rp);
        ...
        /// 需求量计算按钮
        /// </summary>
        /// <param name="name">只有参数为 空 ,才会有提示</param>
        public void AutoCalculation(string name)
        {
            ...
            foreach (var model in lm103List)
            {
                ...
                if (!model.IsNull("COL_4") && !model.IsNull("COL_5") && !model.IsNull("COL_17") && !model.IsNull("COL_19") && !model.IsNull("COL_8") && !model.IsNull("COL_9"))
                {
                    ...
                    {
                        ///    实际用量 =( 密度 X   (厚度/100)  X 宽度  X (长度/1000)   X 实需张数  ) / 1000
                        decimal COL_12 = (COL_5 * (COL_17 / 100m) * col_4 * (COL_19 / 1000m) * COL_8) / 1000m;

                        decimal x = Math.Round(COL_12);
                ...
                //decipher.UpdateModelProps(model, "COL_64", "COL_65", "COL_7", "COL_19", "COL_8", "COL_12", "COL_18");
