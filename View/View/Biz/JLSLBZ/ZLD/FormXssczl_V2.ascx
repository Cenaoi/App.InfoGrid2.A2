<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormXssczl_V2.ascx.cs" Inherits="App.InfoGrid2.View.Biz.JLSLBZ.ZLD.FormXssczl_V21" %>
...
<mi:Store runat="server" ID="StoreUT102" Model="UT_102" IdField="ROW_IDENTITY_ID" DeleteRecycle="true">
    ...
    <InsertParams>
        <mi:QueryStringParam Name="COL_13" QueryStringField="id" />
        <mi:Param Name="COL_16" DefaultValue="彩盒成品" />
    </InsertParams>
    <SummaryFields>
        ...
        <mi:Panel runat="server" ID="panel3" Dock="Top" Scroll="None" Height="110">
            ...
            <mi:Table runat="server" ID="Table106" Dock="Full" StoreID="StoreUT106" Height="100" PagerVisible="false">
                <Columns>
                    <mi:RowNumberer />
                    <mi:RowCheckColumn />
                    <mi:TriggerColumn HeaderText="刀具编号" DataField="COL_27" OnButtonClick="showDialgoForTable_102(this,'VIEW',710)" ButtonClass="mi-icon-more"  Width="90"
                    ...
                    <mi:BoundField HeaderText="刀具名称" DataField="COL_1" Width="180" EditorMode="None" />
...
<script type"text/javascript">
    ...
    function showDialgoForTable(owner) {
        ...
        var filter2 = '[{field:"UT_091.COL_1",logic:"=",value:"彩盒成品"}]';
