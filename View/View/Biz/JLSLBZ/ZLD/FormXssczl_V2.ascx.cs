...
{
    public partial class FormXssczl_V21 : WidgetControl, IView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                this.headLab.Value = "<span class='page-head' >彩盒指令单</span>";
        ...
        void StoreUT103_Updating(object sender, ObjectCancelEventArgs e)
        {
            ...
            if (!model.IsNull("COL_7") && !model.IsNull("COL_11"))
            {
                ...
                model["COL_12"] = COL_8;
                this.StoreUT103.SetRecordValue(e.SrcRecord.Id, "COL_12", COL_8);
        ...
        public void Print(string PrintCode)
        {
            ...
            try
            {
                ...
                string patha = Server.MapPath("/PrintTemplate/彩盒施工单-OK.xls");
