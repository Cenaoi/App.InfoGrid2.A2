<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintTemplateDZD.ascx.cs" Inherits="App.InfoGrid2.View.PrintTemplate.PrintTemplateDZD" %>
    ...
    <mi:Panel runat="server" ID="Panel1" Dock="Full" Region="Center" Scroll="None" >
     ...
     <mi:WindowFooter runat="server" ID="footer1">
        <mi:Button runat="server" ID="OkBtn" Text="打印" Width="80" Height="26" Command="btnPrint"
            Dock="Center" />
         <mi:Button runat="server" ID="btnInputOut" Text="导出" Width="80" Height="26" Command="InputOut"
            Dock="Center" />
