<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintTemplateSingleTable.ascx.cs" Inherits="App.InfoGrid2.View.PrintTemplate.PrintTemplateSingleTable" %>
