...
namespace App.InfoGrid2.View.CustomPage.Mall
{
    ...
    /// 服装厂的尺寸规格档案表
    /// </summary>
    public class T1961_0_Page: ExPage
    {
        ...
        private void MainStore_Updated(object sender, EasyClick.Web.Mini2.ObjectEventArgs e)
        {
            ...
            LModel lm379 = decipher.GetModelByPk("UT_379", lm.GetPk());
            ...
            lmSpec["SPEC_NO"] = lm379["COL_1"];
            lmSpec["SPEC_TEXT"] = lm379["COL_4"];
            lmSpec["CATALOG_CODE"] = lm379["COL_2"];
            lmSpec["CATALOG_TEXT"] = lm379["COL_3"];
            lmSpec["COL_6"] = lm379["COL_6"];
            lmSpec["ROW_DATE_UPDATE"] = DateTime.Now;

            decipher.UpdateModelProps(lmSpec, "SPEC_NO", "SPEC_TEXT", "CATALOG_CODE", "CATALOG_TEXT", "ROW_DATE_UPDATE", "COL_6");
