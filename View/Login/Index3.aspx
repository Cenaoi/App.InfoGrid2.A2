<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index3.aspx.cs" Inherits="App.InfoGrid2.Login.Index3" %>
    ...
    <body>
        ...
        <div class="page-container" style="width:800px;" >
            <form action="" method="post">
                ...
                <br />
                <button type="submit" name="Action" value="Submit" class="submit_button" style="width:340px;">登录11</button>
