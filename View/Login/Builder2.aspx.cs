...
{
    public partial class Builder2 : EC5.SystemBoard.Web.UI.Page, IView
    {
        ...
        private void GoSubmit()
        {
            ...
            try
            {
                ...
                Response.Redirect($"/app/InfoGrid2/View/Explorer/Main_v201608.aspx?_rum={Guid.NewGuid()}", false);
            }
            catch (Exception ex)
            {
