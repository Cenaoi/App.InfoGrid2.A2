/// <reference path="../SUI/swiper-3.4.0.min.js" />
...
loadScript("/Core/Scripts/m5/M5.min.js", function () {
    ...
    loadScript("/Core/Scripts/vue/vue-2.0.1.js", function () {
        ...
        loadScript("/Core/Scripts/XYF/moveobj.js");
    ...
    loadScript("/Core/Scripts/XYF/xyfUtil.js?v=20170606003");
...
window.addEventListener("load", function () {
    ...
    Vue.component('wx-img-upload', {
        ...
        template: '<div class="row" style="padding:0px 20px;background-color:white;margin-top:10px;">\
                        ...
                        <div class="col-50" style="margin: 0px;font-size: 1.3rem;text-align: right;padding-right: 1rem;">\
                            <span class="icon icon-picture" @click="img_upload()"></span>\
                            <input id="wx_img_upload_native_input" type="file" style="display: none;" @change="file_change">\
                        </div>\
                        <div class="col-25" style="position:relative;margin-top:20px;" v-for="i in imgs.data">\
                            <div style="overflow: hidden;">\
                                <img :src="i.thumb_url" style="width:100%;" @click="img_click(i)" />\
        ...
        methods: {
            ...
            img_upload: function () {
                ...
                //看看这个变量存不存在  限制上传图片的最多数量
                if (my_vue.img_num) {

                    //当前图片的数量
                    var cur_len = my_vue.imgs.data.length;

                    if (cur_len >= my_vue.img_num) {

                        $.alert("只能上传【" + my_vue.img_num + "】张图片");
            ...
            file_change: function (e) {
                ...
                var files = Array.prototype.slice.apply(me.files);


                //var load_sid = $.preloader();
                ...
                files.forEach(function (v, i) {
                    ...
                    reader.onload = function () {
                        ...
                        xyf_util.drawImage(me.result, { width: 500 }, function (base64) {
                    ...
                    //fd.append("action", "UPLOAD_IMG_V1");
                    //fd.append("img_base64", v);
                    //fd.append("table_name", my_vue.imgs.table_name);
                    //fd.append("tag_code", my_vue.imgs.tag_code);
                    //fd.append("item_id", my_vue.imgs.row_id);
                    //fd.append("field_text", my_vue.imgs.field_text);

                    //console.log("准备执行ajax了");

                    //$.ajax({
                    //    url: my_vue.imgs.delete_img_url,
                    //    type: 'POST',
                    //    dataType: 'json',
                    //    data: fd,
                    //    processData: false,
                    ...
                    //        xyf_util.post(my_vue.imgs.delete_img_url, "SAVE_FILE_INFO_BY_FIELD", {
                    //            file_json: file_json,
                    //            table_name: my_vue.imgs.table_name,
                    //            field_text: my_vue.imgs.field_text,
                    //            row_id: my_vue.imgs.row_id
    ...
    Vue.component('form-input-text', {
        props: ['lable', 'field_text', 'table_name', 'pk_field', 'placeholder','post_url','pk','value'],
        template:'<li>'+
                     '<div class="item-content">'+
                     '<div class="item-inner">'+
                        '<div class="item-title label">{{lable}}</div>'+
                        '<div class="item-input">'+
                           '<input type="text" v-model="value" :placeholder="placeholder" @keyup="save_deta" >' +
                        '</div>'+
                      '</div>'+
                    '</div>'+
                  '</li>',
        methods: {
            ...
            save_deta: function () {
                ...
                $.post(my_vue.post_url,
                        {
                            action: 'SAVE_FIELD_DATA',
                            value: my_vue.value,
                            field: my_vue.field_text,
                            table_name: my_vue.table_name,
                            pk:my_vue.pk
                        }, function (result) {
