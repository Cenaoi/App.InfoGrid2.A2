<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowWorkReport.aspx.cs" Inherits="App.InfoGrid2.WF.View.Reim.ShowWorkReport" %>
                            ...
                            <div class="item-content">
                              <div class="item-inner">
                                ...
                                <div class="item-input">
                                  <input type="text" v-model="t.COL_26" readonly="readonly">
                                </div>
                              </div>
                            </div>
                          </li>
            ...
            <script type="text/javascript" data-main="true">
                ...
                function main() {
                    ...
                    obj.getData = function () {
                        ...
                        console.log("me.my_vue.trip_detas:",me.my_vue.trip_detas);
                    }
