...
namespace App.InfoGrid2.GBZZZD.Task
{
    public class SyncOrderHelper
    {
        ...
        public static bool SyncSaleOrder()
        {
            ...
            try
            {
                using (DbDecipher decipher = new SqlServer2005Decipher(TDbConn))
                {
                    foreach (var item in list)
                    {
                        int pkid = item.GetInt("ID");

                        LModel ut90 = ExistsSaleOrder(decipher, pkid);

                        if (ut90 == null)
                        {
                            //新增
                            ut90 = new LModel("UT_90")
                            {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static LModel ExistsSaleOrder(DbDecipher decipher, int id)
        {
            LightModelFilter filter = new LightModelFilter("UT_90");
            ...
            try
            {
                using (DbDecipher decipher = new SqlServer2005Decipher(TDbConn))
                {
                    foreach (var item in list)
                    {
                        ...
                        LModel ut91 = ExistsSaleOrder(decipher, pkid);

                        if (ut91 == null)
                        {
                            //新增
                            ut91 = new LModel("UT_91")
                            {
                                ["BIZ_SID"] = 2,
                        ...
                        else
                        {
                            ...
                            //ut91["COL_11"] = item.GetString("DepotID");
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static LModel ExistsSaleOrderItem(DbDecipher decipher, int id)
        {
            LightModelFilter filter = new LightModelFilter("UT_91");
            ...
            try
            {
                using (DbDecipher decipher = new SqlServer2005Decipher(TDbConn))
                {
                    foreach (var item in list)
                    {
                        ...
                        LModel ut101 = ExistsSaleOrder(decipher, pkid);
                        ...
                        if (ut101 == null)
                        {
                            ...
                            {
                                //["COL_33"] = item.GetString(""),
                                ["COL_71"] = item.GetString("GetMan"),
                                ["COL_72"] = 100,
                                ["COL_73"] = "未开始",
                                ["COL_1"] = item.GetInt("BillNo"),
                                ...
                                //["COL_106"] = item.GetString(""),
                                //["COL_107"] = item.GetString(""),
                        ...
                        else
                        {
                            ...
                            ut101["COL_1"] = item.GetInt("BillNo");
                            ...
                            //ut101["COL_106"] = item.GetString("");
                            //ut101["COL_107"] = item.GetString("");
        ...
        {
            string sql = $"select * from GetList ";
            ...
            try
            {
                using (DbDecipher decipher = new SqlServer2005Decipher(TDbConn))
                {
                    foreach (var item in list)
                    {
                        ...
                        LModel ut104 = ExistsSaleOrder(decipher, pkid);

                        if (ut104 == null)
                        {
                            //新增
                            ut104 = new LModel("UT_104")
                            {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static LModel ExistsPickingOrderItem(DbDecipher decipher, int id)
        {
