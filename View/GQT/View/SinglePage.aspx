<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SinglePage.aspx.cs" Inherits="App.InfoGrid2.GQT.View.SinglePage" %>
...
<body style="max-width:520px;margin:auto;font-family:Microsoft YaHei,Helvitica,Verdana,Tohoma,Arial,san-serif;">
    ...
    <div class="page-group">
        ...
        <div class="page">
            ...
            <!--内容容器-->
            <div class="content" style="padding:0.5rem; background-color:#FFF;">
            ...
            <script type="text/javascript" data-main="true">
                ...
                function main() {
                    ...
                    obj.onInit = function () {
                        ...
                        $.post("/GQT/Handlers/CmsHandler.ashx", { action: 'GET_TILE', menu_id: menu_id }, function (result) {
                            ...
                            el.find(".def_title").text(result.data.MENU_TEXT);

                            var item_content = result.data.TILE_CONTEXE;

                            var itemContentEl = $("<div>" + item_content + "</div>");
