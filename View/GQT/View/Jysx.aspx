<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jysx.aspx.cs" Inherits="App.InfoGrid2.GQT.View.Jysx" %>
    ...
    <div class="page-group">
        ...
        <div class="page" >
            ...
            <header class="bar bar-nav">
                ...
                <h1 class="title def_title">就业实习</h1>
            ...
            <div class="content" >
                ...
                <div class="row" style="padding:0.5rem;">
                    <div class="col-50 cms_menu" style="margin-top:10px;" data-url="Yjpp.aspx" >
                    ...
                    <div class="col-50 cms_menu" style="margin-top:10px;" data-url="Gwcz.aspx" >
                    ...
                    <div class="col-50 cms_menu" style="margin-top:10px;" data-url="ArticlePage.aspx?menu_id=23&cata_id=1">
                    ...
                    <div class="col-50 cms_menu" style="margin-top:10px;" data-url="ArticlePage.aspx?menu_id=24&cata_id=1" >
