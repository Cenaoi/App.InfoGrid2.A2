<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserListM2.ascx.cs" Inherits="App.InfoGrid2.Sec.User.UserListM2" %>
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="Center" Scroll="None" >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" >
            <Columns>
                ...
                <mi:BoundField DataField="LOGIN_PASS"  HeaderText="登陆密码"  />
