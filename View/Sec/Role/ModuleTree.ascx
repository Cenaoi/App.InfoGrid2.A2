<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ModuleTree.ascx.cs" Inherits="App.InfoGrid2.Sec.Role.ModuleTree" %>
...
<script type="text/javascript">
    ...
    function Seelct_FunList(event, data) {
        ...
        frm.location.href = "FunSetup.aspx?moduleId=" + value + "&roleId=" + $.query.get("roleid") ;
