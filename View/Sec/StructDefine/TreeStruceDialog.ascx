<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreeStruceDialog.ascx.cs" Inherits="App.InfoGrid2.Sec.StructDefine.TreeStruceDialog" %>
...
<mi:Viewport runat="server" ID="viewport1">
    <mi:Panel runat="server" ID="panel1" Region="Center">
        <mi:TreePanel runat="server" ID="TreePanel1" Dock="Full">
            <Types>
    ...
    <mi:WindowFooter runat="server" ID="footer1" >
        <mi:Button runat="server" Text="确定" Command="GoSubmit" Width="80" Dock="Center" />
        <mi:Button runat="server" Text="取消" OnClick="ownerWindow.close()" Width="80" Dock="Center" />
    </mi:WindowFooter>
</mi:Viewport>
