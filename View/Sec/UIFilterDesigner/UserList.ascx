<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserList.ascx.cs" Inherits="App.InfoGrid2.Sec.UIFilterDesigner.UserList" %>
...
<mi:Store runat="server" ID="store1" Model="SEC_ROLE" IdField="SEC_ROLE_ID" PageSize="0" ReadOnly="true">
    ...
    <mi:Panel runat="server" ID="centerPanel" Dock="Full" Region="West" Scroll="None" Width="200"  >
        ...
        <mi:Table runat="server" ID="table1" StoreID="store1" Dock="Full" PagerVisible="false" CheckedMode="Single" AutoRowCheck="true" >
            <Columns>
                <mi:RowNumberer />
                <mi:RowCheckColumn />
                <mi:BoundField HeaderText="角色名称" DataField="TEXT" />
                <mi:BoundField HeaderText="角色代码" DataField="ROLE_CODE" />
            </Columns>
        </mi:Table>
    </mi:Panel>
