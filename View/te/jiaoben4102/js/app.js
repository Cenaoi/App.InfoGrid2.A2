...
$("document").ready(function(){
	...
	//     || localStorage.getItem("itemg") + "px");
	//    $("div.item").css("line-height", "50px" || localStorage.getItem("itemg") + "px");
    //}
	$("div.item").css("width", "120px");

	$("div.item").css("height", "50px");
	$("div.item").css("line-height", "50px");
	...
	$("body").keydown(function(e){
		...
		if(e.keyCode==32||e.keyCode==65){
			...
			if(!isRun){
                ...
                var id = Math.ceil(Math.random() * jj.length - 1);
