...
namespace EasyClick.Web.Mini
{
    ...
    [Description("可编辑的下拉框")]
    public class DropDownText:MiniHtmlListBase
    {
        /// <summary>
        /// 下拉框
        /// </summary>
        ...
        protected virtual void Render_Script(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine("var {0} = new Mini.ui.DropDownText({{id:'{0}',width:'{1}',officeY:{2} }});", this.GetClientID(), width, m_OfficeY);
            writer.WriteLine("</script>");
        }
