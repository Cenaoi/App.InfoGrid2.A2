...
namespace App.InfoGrid2.Model
{
    ...
    [Description("表定义")]
    [Serializable]
    public class IG2_TABLE : LightModel
    {
        ...
        /// </summary>
        [DBField]
        [DisplayName("表类型.TABLE-数据表;VIEW-视图表;AREA-页区域表")]
        ...
        /// </summary>
        [DBField]
        public string BTN_EDIT_COMMAND { get; set; }
        ...
        /// </summary>
        [DBField]
        public bool FLOW_ENABLED { get; set; }
        ...
        /// [{
        ///     BIZ_SID : 0,
        ///     FLOW_CODE : "FLLOW_123123"
        /// },{
        ///     BIZ_SID :4,
        ///     FLOW_CODE: "FLOW_3243242"
        /// }]
        /// </example>
        [DBField]
        public string FLOW_PARAMS { get; set; }
