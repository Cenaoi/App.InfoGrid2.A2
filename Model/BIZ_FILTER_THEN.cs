...
namespace App.InfoGrid2.Model
{
    ...
    /// 过滤-执行
    /// </summary>
    [DBTable("BIZ_FILTER_THEN")]
    [Description("过滤-执行")]
    [Serializable]
    public class BIZ_FILTER_THEN : LightModel
    {
        ...
        /// </summary>
        [DBField]
        [DisplayName("执行代码类型。默认：TABLE")]
        [LMValidate(maxLen = 20)]
        [UIField(visible = true)]
        public String THEN_TYPE_ID { get; set; }
