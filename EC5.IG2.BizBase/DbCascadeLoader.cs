...
namespace EC5.IG2.BizBase
{
    ...
    public class DbCascadeLoader
    {
        ...
        public void InitDbcc()
        {
            ...
            filter.TSqlOrderBy = "EXEC_SEQ DESC,IG2_ACTION_ID ASC";
        ...
        private DbccModel ConvertModel(DbccActionSet daSet)
        {
            ...
            dModel.ListenLogic = EnumUtil.Parse(act.LISTEN_AO, DbccLogic.OR);

            dModel.AutoContinue = act.AUTO_CONTINUE;

            dModel.ActNewEnabeld = act.ACT_NEW_ENABLED;
            dModel.ActNewSCode = act.ACT_NEW_SCODE;
            dModel.ActUpdateEnabled = act.ACT_UPDATE_ENABLED;
            dModel.ActUpdateSCode = act.ACT_UPDATE_SCODE;
        ...
        private DbccThen ConvertForThen(IG2_ACTION_THEN item)
        {
            ...
            dThen.A_Login = ModelConvert.ToLogic(logic);// EnumUtil.Parse<Logic>(item.A_LOGIN, Logic.Equality, true);
        ...
        {
            string logic = actFilter.A_LOGIN;
            ...
            item.A_Logic = ModelConvert.ToLogic(logic);
