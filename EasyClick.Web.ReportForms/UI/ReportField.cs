...
namespace EasyClick.Web.ReportForms.UI
{
    ...
    /// 
    /// </summary>    
    [ParseChildren(true, "FixedValues")]
    [AspNetHostingPermission(SecurityAction.Demand, Level = AspNetHostingPermissionLevel.Minimal)]
    public class ReportField
    {
        RFieldValueCollection m_FixedValues;
        ...
        public RFieldValueCollection FixedValues
        {
            get
            {
                if (m_FixedValues == null)
                {
                    m_FixedValues = new RFieldValueCollection();
                }
